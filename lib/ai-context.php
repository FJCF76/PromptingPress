...
function pp_ai_system_prompt(): string {
    ...
    $parts[] = 'HOVER: a `":hover"` key inside a group holds the same parameters for the hover state, and its values may themselves be breakpoint maps — `"quote": {"typography": {"color": "#111111", ":hover": {"color": "#000000"}}}`.';
