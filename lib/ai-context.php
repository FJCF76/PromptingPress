    ...
    if ($components) {
        ...
        foreach ($components as $name => $schema) {
            ...
            if ($roles) {
                ...
                $parts[] = "  UDC roles (style through the `udc` map, NOT style_component): "
                    . implode('; ', $role_parts);
            }
