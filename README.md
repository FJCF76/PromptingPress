...
[![Version](https://img.shields.io/badge/version-0.16.129-6366F1?style=flat-square)](CHANGELOG.md)
...
188 per-instance style slots let AI make this page's hero dark and spacious while that page's hero is tight, accent-bordered, and lifted with a drop shadow — all through composition data, no CSS edits. 11 named recipes (like `dark-spacious` or `compact`) expand to multiple slot values at once.
...
- 12 components with schema contracts and 188 per-instance style slots, plus named recipes
