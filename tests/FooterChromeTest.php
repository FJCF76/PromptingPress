...
class FooterChromeTest extends TestCase
{
    ...
    public function testUnsetFooterRendersDefaultCopyrightWithoutTextMutedClass(): void
    {
        ...
        // an authored footer text colour on a dark footer; the copyright must not carry it.
    ...
    public function testBaseTemplateMapsEveryFooterOption(): void
    {
        ...
        // The three COLOUR options are gone (ruling A1); the CONTENT options stay,
        // and base.php must still read every one of them.
        foreach (['pp_footer_blurb', 'pp_footer_contact', 'pp_footer_copyright'] as $opt) {
