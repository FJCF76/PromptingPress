...
class SchemaValidationTest extends TestCase
{
    ...
    private const SLOT_RENAME_MIGRATION_NOTES = [
        ...
        'cta' => [
            ...
            '--cta-heading-color' => 'REPLACED in v2 (#1026) by the `heading` role\'s `typography.color`. Note: the role declares NO default for it, unlike most of this list. v1\'s rule was `color: var(--cta-heading-color, inherit)` — the fallback was the inherited value, not a value — so the faithful port is no default at all, and the heading keeps following its band the way it always did.',
